...
class Song:
    ...
    def create_track(self, type: int,
        ...
        if assign_default_sampler_plugin and type == TrackType.MIDI_TRACK:
            new_track.set_sampler_plugin(self.create_audio_plugin(AudioPlugin.DEFAULT_SYNTH_TF_ID))
    ...
    def insert_track(self, index: int, track: Track):
        self._proto.tracks.insert(index, track._proto)
